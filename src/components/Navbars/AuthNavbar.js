            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-black text-black fab fa-facebook text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  className="lg:text-black lg:hover:text-black text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                  href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fdemos.creative-tim.com%2Fnotus-react%2F%23%2F&text=Start%20your%20development%20with%20a%20Free%20Tailwind%20CSS%20and%20React%20UI%20Kit%20and%20Admin.%20Let%20Notus%20React%20amaze%20you%20with%20its%20cool%20features%20and%20build%20tools%20and%20get%20your%20project%20to%20a%20whole%20new%20level.%20"
                  target="_blank"
                >
                  <i className="lg:text-black text-black fab fa-twitter text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-black text-black fab fa-github text-lg leading-lg " />
